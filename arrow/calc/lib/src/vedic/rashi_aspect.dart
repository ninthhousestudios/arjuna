...
class RashiAspect {
  ...
  static bool doesAspect(int fromSign, int toSign,
  ...
  static bool doesAspectWithOccupants(
      int fromSign, int toSign, bool fromHasGrahas,
      [RashiAspectMode mode = RashiAspectMode.quadrant]) {
  ...
  static int mutual(
      ...
      [RashiAspectMode mode = RashiAspectMode.quadrant]) {
    final oneToTwo = doesAspectWithOccupants(sign1, sign2, sign1HasGrahas, mode);
    final twoToOne = doesAspectWithOccupants(sign2, sign1, sign2HasGrahas, mode);
