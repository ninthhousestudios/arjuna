...
class SignData {
  ...
  static const qualities = <int, Quality>{
    1: Quality.cardinal,  2: Quality.fixed,    3: Quality.mutable,
    4: Quality.cardinal,  5: Quality.fixed,    6: Quality.mutable,
    7: Quality.cardinal,  8: Quality.fixed,    9: Quality.mutable,
    10: Quality.cardinal, 11: Quality.fixed,  12: Quality.mutable,
  };

  /// Genders: odd signs = male, even signs = female
  static const genders = <int, Gender>{
    1: Gender.male,   2: Gender.female,  3: Gender.male,   4: Gender.female,
    5: Gender.male,   6: Gender.female,  7: Gender.male,   8: Gender.female,
    9: Gender.male,  10: Gender.female, 11: Gender.male,  12: Gender.female,
  };
