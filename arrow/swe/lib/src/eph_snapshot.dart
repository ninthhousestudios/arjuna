...
abstract class EphSnapshot with _$EphSnapshot {
  const factory EphSnapshot({
    ...
    @BodyDoubleMapConverter()
    @Default(<Body, double>{})
    Map<Body, double> bodiesNakEclLon,
    @BodyDoubleMapConverter()
    @Default(<Body, double>{})
    Map<Body, double> bodiesNakEquLon,
    @StarDoubleMapConverter()
    @Default(<Star, double>{})
    Map<Star, double> starsNakEclLon,
    @StarDoubleMapConverter()
    @Default(<Star, double>{})
    Map<Star, double> starsNakEquLon,
    @StringDoubleMapConverter()
    @Default(<String, double>{})
    Map<String, double> customStarsNakEclLon,
    @StringDoubleMapConverter()
    @Default(<String, double>{})
    Map<String, double> customStarsNakEquLon,
    ...
    @StarPositionMapConverter()
    @Default(<Star, StarPosition>{})
    Map<Star, StarPosition> stars,
    @StringStarPositionMapConverter()
    @Default(<String, StarPosition>{})
    Map<String, StarPosition> customStars,
  }) = _EphSnapshot;
